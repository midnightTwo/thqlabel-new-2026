...
const toastConfig = {
  success: {
    icon: `<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>`,
  ...
  error: {
    icon: `<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M6 18L18 6M6 6l12 12"/></svg>`,
  ...
  info: {
    icon: `<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`,
  ...
  warning: {
    icon: `<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>`,
...
export function showToast({ message, type, duration = 4000 }: ToastOptions): void {
  ...
  toast.className = 'thq-toast fixed top-6 left-1/2 -translate-x-1/2 z-[99999]';
  ...
  toast.innerHTML = `
    <div class="flex items-center gap-3 px-5 py-4 rounded-2xl border backdrop-blur-2xl bg-gradient-to-r ${config.bgClass} ${config.borderClass} shadow-2xl ${config.glowClass} min-w-[300px] max-w-[450px]"
      ...
      <div class="w-12 h-12 rounded-xl ${config.iconBg} flex items-center justify-center text-white shrink-0 shadow-lg"
