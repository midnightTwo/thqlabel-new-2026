...
const FlagSVGs: { [key: string]: React.FC<{ className?: string }> } = {
  ...
  'Киргизия': ({ className }) => (<svg viewBox="0 0 9 6" className={className}><rect width="9" height="6" fill="#E8112D"/><circle cx="4.5" cy="3" r="1.5" fill="#FFEF00"/><circle cx="4.5" cy="3" r="0.9" fill="#E8112D"/><g stroke="#FFEF00" strokeWidth="0.15">{[...Array(40)].map((_, i) => <line key={i} x1="4.5" y1="3" x2={4.5 + 1.2 * Math.cos(i * Math.PI / 20)} y2={3 + 1.2 * Math.sin(i * Math.PI / 20)}/>)}</g></svg>),
  'Кыргызстан': ({ className }) => (<svg viewBox="0 0 9 6" className={className}><rect width="9" height="6" fill="#E8112D"/><circle cx="4.5" cy="3" r="1.5" fill="#FFEF00"/><circle cx="4.5" cy="3" r="0.9" fill="#E8112D"/></svg>),
  ...
  'Тувалу': ({ className }) => (<svg viewBox="0 0 640 480" className={className}><defs><clipPath id="tv"><path d="M0 0h640v480H0z"/></clipPath></defs><g clipPath="url(#tv)"><path fill="#009fca" d="M0 0h640v480H0z"/><path fill="#fff" d="M0 0h320v240H0z"/><path fill="#00247d" d="M0 0h320v240H0z"/><path fill="#fff" d="M0 0v26.9L140.8 120H160v-26.9L19.2 0H0zm160 0v26.9L19.2 120H0V93.1L140.8 0H160z"/><path fill="#cf142b" d="M66.7 0v120h26.6V0H66.7zM0 40v40h160V40H0z"/><path fill="#cf142b" d="M0 0v14.9l140.8 105.1h19.2V105.1L19.2 0H0zm160 0v14.9L19.2 120H0v-14.9L140.8 0H160z"/><g fill="#fce100"><path d="m505 251 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.6-14.5 10.5 5.5-17-14.5-10.4h18z"/><path d="m525 319 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m589 287 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m461 319 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m429 255 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m397 319 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m461 391 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m525 391 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/><path d="m557 351 5.5 17h18l-14.5 10.5 5.5 17-14.5-10.5-14.5 10.5 5.5-17-14.5-10.5h18z"/></g></g></svg>),
};
