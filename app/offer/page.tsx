        ...
        <article className="space-y-8" style={{ color: textSecondary }}>
          ...
          <section>
            ...
            <div className="space-y-3 text-sm leading-relaxed pl-4">
              ...
              <p>
                <span style={{ color: accentColor }}>1.3.</span> Настоящая публичная оферта регулирует отношения сторон, 
                связанные с применением простой электронной подписи (ПЭП).
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-sm leading-relaxed pl-4">
              ...
              <p>
                <span style={{ color: accentColor }}>2.7.</span> <strong>Простая электронная подпись (ПЭП)</strong> — электронный аналог личной подписи 
                физического лица, использующей средства аутентификации и идентификации личности клиента (логин, пароль, SMS-код, почта).
              </p>
              <p>
                <span style={{ color: accentColor }}>2.8.</span> Договор не требует скрепления печатями и/или 
          ...
          <section>
            ...
            <div className="space-y-3 text-sm leading-relaxed pl-4">
              ...
              <p>
                <span style={{ color: accentColor }}>3.5.</span> Договор вступает в силу при наличии записи, подтверждающей 
                добровольное согласие пользователя на применение данной формы подписи (отметка «Подтверждаю» при регистрации).
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-lg font-bold mb-4" style={{ color: textPrimary }}>
              4. Порядок использования ПЭП
            </h2>
            <div className="space-y-3 text-sm leading-relaxed pl-4">
              <p>
                <span style={{ color: accentColor }}>4.1.</span> При выполнении вышеуказанных условий любое юридическое 
                действие, произведённое клиентом на сайте, фиксируется как подписанное его ПЭП. Например:
              </p>
              <ul className="list-disc pl-6 space-y-1" style={{ color: textSecondary }}>
              ...
              <p>
                <span style={{ color: accentColor }}>4.2.</span> Эти действия будут признаны юридическим актом выражения 
                воли пользователя и формальным выражением согласия с предлагаемым договором.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-sm leading-relaxed pl-4">
              <p>
                <span style={{ color: accentColor }}>5.1.</span> Пользователь несёт ответственность за сохранность своего 
                аккаунта и конфиденциальность используемых для подписания данных (пароль, SMS-код и др.). Если произошло 
                несанкционированное использование вашей ПЭП третьими лицами, немедленно сообщите нам любым доступным способом.
              </p>
              <p>
                <span style={{ color: accentColor }}>5.2.</span> Таким образом, если соблюдены указанные требования, 
                ваше участие в операциях на нашем ресурсе будет считаться юридически значимым действием, равносильным 
                подписанию договора собственной рукой.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-sm leading-relaxed pl-4">
              <p>
                <span style={{ color: accentColor }}>6.1.</span> Договор вступает в силу со дня акцепта заказчиком 
